  ...
  return (
    <div className="flex flex-1 flex-col bg-zinc-50 font-sans dark:bg-black">
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-6 py-16">
        ...
        <p className="mt-1 text-sm text-zinc-500">Última atualização: {updatedAt}</p>
        ...
        <div
          ...
          [&_p]:mt-3 [&_p]:text-zinc-600 dark:[&_p]:text-zinc-400
          [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:text-zinc-600 dark:[&_ul]:text-zinc-400
          [&_li]:mt-1"
        >
          {children}
        </div>
